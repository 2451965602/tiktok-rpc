...
type Client interface {
	...
	LikeList(ctx context.Context, req *interact.LikeListRequest, callOptions ...callopt.Option) (r *interact.LikeListResponse, err error)
...
func (p *kInteractServiceClient) LikeList(ctx context.Context, req *interact.LikeListRequest, callOptions ...callopt.Option) (r *interact.LikeListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
